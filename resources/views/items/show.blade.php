        ...
        <section class="grid gap-6 lg:grid-cols-[320px_1fr]">
            ...
            <div class="space-y-6">
                <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    @foreach ([
                        ['label' => 'Total Units', 'value' => $campusTotal, 'class' => 'text-gray-900'],
                        ['label' => 'Available', 'value' => $campusAvailable, 'class' => 'text-green-700'],

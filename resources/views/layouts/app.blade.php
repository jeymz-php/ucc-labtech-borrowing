            ...
            <nav class="flex-1 overflow-y-auto px-4 py-6">
                ...
                <div class="space-y-1">
                    ...
                    @can('view categories')
                        ...
                        >
                            <img
                                src="{{ asset('images/icons/category_icon.png') }}"
                                alt=""
                                aria-hidden="true"
                    ...
                    @endcan
                    @if(auth()->user()->can('view all borrowings') || auth()->user()->can('view own borrowings'))
                        <a
                        ...
                        >
                            <img
                                src="{{ asset('images/icons/borrowing_icon.png') }}"
                                alt=""
                                aria-hidden="true"
                                class="h-5 w-5 shrink-0 object-contain"
                            >
